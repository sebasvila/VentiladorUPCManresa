 ...
 *
 * Alarms are:
 * (1) Fatal alarms: something unrecoverable happened. Mostly internal errors.
 ...
 * The pattern describes the value `e` and follows this sequence: two long
 * dashes (sync) and `e` short dots.
 */
